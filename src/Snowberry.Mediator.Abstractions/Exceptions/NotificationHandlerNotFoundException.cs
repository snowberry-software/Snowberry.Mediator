...
public class NotificationHandlerNotFoundException(Type notificationType) : Exception($"No notification handler found for notification type: {notificationType.FullName}.")
{
    /// <summary>
