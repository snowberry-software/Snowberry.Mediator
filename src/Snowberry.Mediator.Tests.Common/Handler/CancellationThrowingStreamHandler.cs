...
{
    public async IAsyncEnumerable<int> HandleAsync(CancellationThrowingStreamRequest request, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
