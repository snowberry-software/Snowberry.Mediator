...
/// </summary>
public class NotificationTests : Common.MediatorTestBase
{
    [Fact]
    public async Task Test_SimpleNotification_SingleConcreteHandler()
    {
        ...
        var receivedNotification = SimpleNotificationHandler.ReceivedNotifications[0];
    ...
    public async Task Test_UserRegisteredNotification_MultipleConcreteHandlers()
    {
        ...
        var processedUser = UserRegisteredNotificationHandler.ProcessedUsers[0];
        ...
        string emailSent = UserRegistrationEmailHandler.EmailsSent[0];
    ...
    public async Task Test_OpenGenericHandlers_SingleNotification()
    {
        ...
        Assert.Equal(1, GenericLoggingHandler<SimpleNotification>.LoggedNotifications.Count);
        Assert.Contains("SimpleNotification", GenericAuditingHandler<SimpleNotification>.AuditLog.Keys);
        Assert.Equal(1, GenericAuditingHandler<SimpleNotification>.AuditLog["SimpleNotification"].Count);
...
/// </summary>
public class ExceptionThrowingNotificationHandler : INotificationHandler<SimpleNotification>
{
